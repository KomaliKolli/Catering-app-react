...
//                     <th scope="col">Add to Cart</th> {/* New column for Add to Cart button */}
//                   </tr>
//                 </thead>
//                 <tbody>
//                   {cartProducts.map((cartProduct) => (
...
//                         <button
//                           onClick={() => addToCart(cartProduct)} // You need to implement this function
...
//   removeItem,
//   updateQuantity,
//   clearCart // Add the clearCart action
// } from "../../redux/cartSlice";
...
//                   <button
//                     onClick={handleClearCart} // Add onClick handler for clearing the cart
//                     className="btn border-secondary rounded-pill px-4 py-3 text-primary text-uppercase mb-4 ms-4"
//                     type="button"
//                   >
//                     Clear Cart
